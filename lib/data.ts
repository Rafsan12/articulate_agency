      ...
      gallery: [
        {
          ...
          caption: "The opening slide establishes the branded entry point and sets the tone for the learner experience.",
          accent: "blue",
          imageSrc: "/Welcome%20to%20Clientilo%20(1)/story_content/thumbnail.jpg",
          imageAlt: "Welcome slide for the Clientilo Storyline experience.",
        },
        {
          title: "Slide 2 — Introduction",
          caption: "The second slide moves into context-setting, giving learners a clear picture of what to expect.",
          accent: "emerald",
          imageSrc: "/Welcome%20to%20Clientilo%20(1)/mobile/61Vwdy5Y5d1.png",
          imageAlt: "Introduction slide from the Clientilo Storyline module.",
        },
        {
          title: "Slide 3 — Platform Overview",
          caption: "Learners get their first look at the platform interface with guided orientation cues.",
          accent: "amber",
          imageSrc: "/Welcome%20to%20Clientilo%20(1)/mobile/6Jz8jxsPsFT.png",
          imageAlt: "Platform overview slide from the Clientilo Storyline experience.",
        },
        {
          title: "Slide 4 — Onboarding Steps",
          caption: "A structured walkthrough of the key onboarding actions learners need to complete.",
          accent: "rose",
          imageSrc: "/Welcome%20to%20Clientilo%20(1)/mobile/6QFYCxTlAha.png",
          imageAlt: "Onboarding steps slide from the Clientilo Storyline module.",
        },
        {
          title: "Slide 5 — Key Features",
          caption: "Core platform features are highlighted with clear visual hierarchy to support retention.",
          accent: "cyan",
          imageSrc: "/Welcome%20to%20Clientilo%20(1)/mobile/5ZtxlYgTgq3.png",
          imageAlt: "Key features slide from the Clientilo Storyline experience.",
        },
        {
          title: "Slide 6 — Getting Started",
          caption: "The action-oriented slide prompts learners to take their first step inside the platform.",
          accent: "violet",
          imageSrc: "/Welcome%20to%20Clientilo%20(1)/mobile/6WLOvAYDTzU.png",
          imageAlt: "Getting started slide from the Clientilo Storyline module.",
        },
        {
          title: "Slide 7 — Next Steps",
          caption: "The closing slide reinforces the path forward and gives learners a clear sense of completion.",
          accent: "blue",
          imageSrc: "/Welcome%20to%20Clientilo%20(1)/mobile/6pDVlX4xu8Y.png",
          imageAlt: "Next steps slide from the Clientilo Storyline experience.",
        },
      ],
      stats: [
        {
