...
export default function AboutPage() {
  return (
    <div className="bg-zinc-950 text-white font-sans selection:bg-blue-500/30 selection:text-white">
      {/* 1. HERO SECTION */}
      <section className="pt-32 pb-20 px-4 md:px-12 lg:px-24 text-center">
        <div className="container mx-auto max-w-4xl">
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-zinc-400 leading-relaxed max-w-3xl mx-auto"
          >
      ...
      <section className="py-20 px-4 md:px-12 lg:px-24 bg-zinc-950">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {values.map((item, index) => (
              <motion.div
                ...
                className="flex items-start gap-6 p-8 rounded-2xl border border-zinc-800 bg-zinc-900/70 shadow-[0_18px_60px_-40px_rgba(59,130,246,0.35)] transition-colors hover:border-zinc-700 hover:bg-zinc-900"
              >
                <div className="h-14 w-14 shrink-0 rounded-xl bg-blue-500 flex items-center justify-center text-white shadow-lg shadow-blue-500/20">
                  <item.icon size={28} />
                </div>
                <div>
      ...
      <section className="py-24 px-4 md:px-12 lg:px-24 bg-linear-to-b from-zinc-950 to-zinc-900/70">
        <div className="container mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
            ...
            <div className="lg:w-1/2">
              ...
              <ul className="space-y-6">
                {[
                  ...
                  >
                    <div className="h-2 w-2 mt-2.5 rounded-full bg-blue-500 shrink-0" />
                    <div>
                      <span className="font-bold text-zinc-100">
                        {point.title}:{" "}
                      </span>
                      <span className="text-zinc-400">{point.desc}</span>
                    </div>
                  </motion.li>
                ))}
              </ul>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="lg:w-1/2 w-full p-10 md:p-12 rounded-3xl border border-blue-500/20 bg-linear-to-br from-blue-600 to-cyan-500 text-white shadow-2xl shadow-blue-500/20"
            >
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3">
                    <Check className="h-5 w-5 mt-0.5 text-blue-100 shrink-0" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {steps.map((step, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="p-8 rounded-2xl border border-zinc-800 bg-zinc-900/70 hover:border-zinc-700 hover:bg-zinc-900 transition-colors"
              >
                <span className="block text-blue-400 font-bold text-xl mb-2">
                  {step.step}
                </span>
      ...
      {/* 5. CTA SECTION */}
      <section className="py-24 px-4 bg-linear-to-r from-blue-600 to-cyan-500 text-center">
        <div className="container mx-auto max-w-3xl">
          ...
          <p className="text-blue-50/90 text-lg mb-10">
            Ready to discuss your eLearning project? We&apos;re here to help.
          </p>
          <Button
            size="lg"
            className="h-14 px-8 rounded-full bg-white text-blue-600 hover:bg-zinc-100 font-bold text-lg shadow-xl"
